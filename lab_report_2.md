...
2. Argument involved: in the handleRequest method, the relevant arguments are the URI url (this is the url that will be accessed), String chatOutput (this is a string which stores the information passed into the url) , and int index (this is the index of the information that has passed into the url)
3. Changed values: 
  a. the url is changed to the url of the server + /add-message?s=How are you
  b. the String list params is assigned to value of list splitting the query, params[0] is now "s" and params[1] is now "How are you"
  c. the index is increment by 1 (it is now 2)
  d. the chatOutput is added a new String "2. How are you\n" and is now "1. Hello\n2. How are you\n"
